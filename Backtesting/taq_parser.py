...
E = {'LO_ask+1': 0, 'CO_ask+1': 1, 'LO_ask0': 2, 'CO_ask0': 3, 'MO_ask0': 4,  'LO_ask-1': 5, 
     'LO_bid+1': 6, 'LO_bid0': 7, 'CO_bid0': 8,  'MO_bid0': 9,  'LO_bid-1': 10, 'CO_bid-1': 11}
...
def process_single_day(args):
    ...
    quotes['BIDSIZ'] = quotes['BIDSIZ'] * 100
    quotes['ASKSIZ'] = quotes['ASKSIZ'] * 100
...
def parse_ticker(ticker):
    ...
    print(f"\n[{ticker}] Stitching daily files together.")
